...
interface ILocalActivity extends View.OnClickListener{
	...
	/**
	 * 获得该Activity的来源，即由第几级页面打开，该返回值将决定该Activity返回的动画
	 * @added 1.0
	 * @see ActivitySwitcher#EXTRA_ACTIVITY_SOURCE
	 * @see ActivitySwitcher#SOURCE_FROM_MAIN
	 * @see ActivitySwitcher#SOURCE_FROM_SUB
	 */
	int getActivityStartSource() ;
}
