package com.wuxiadou.network.utils;
...
public class NormalRequestPiecer
{
     ...
     private final static String APPV="appv";
     private final static String PROV="prov";
     private final static String  DEVICE_TYPE="device_type";
    private final static String UA_LABEL = "os";
    ...
    /* 拼装公共信息 */
    private static void pieceCommonInfo(Context context, JSONObject jo) throws Exception
    {
...
//        /* 配置渠道号 */
////        jo.put(CID_LABEL, context.getResources().getString(R.string.cid_num));
//        /* 配置SDK系统版本 */
